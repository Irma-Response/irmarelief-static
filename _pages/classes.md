...
<table width="100%">
    <tbody>
        ...
        <tr>
            <th>
                <p><strong>08.00 - 09.00</strong></p>
            </th>
            <td>
                <p><span style="color: #A58E65;">Foundation Yoga</span></p>   
                <i class="fa fa-clock-o" style="color:#3c5e61;"><!-- icon --></i> 60min
                <i class="fa fa-flag" style="color:#3c5e61;"><!-- icon --></i> Novice, Yogi, Guru
            </td>
            <td>
                <p><span style="color: #A58E65;">Yin Yoga</span></p>   
                <i class="fa fa-clock-o" style="color:#3c5e61;"><!-- icon --></i> 55min
                <i class="fa fa-flag" style="color:#3c5e61;"><!-- icon --></i> Yogi, Guru
            </td>
            <td>
                <p><span style="color: #A58E65;">Foundation Yoga</span></p>   
                <i class="fa fa-clock-o" style="color:#3c5e61;"><!-- icon --></i> 60min
        ...
        <tr>
            ...
            <td>
                <p><span style="color: #A58E65;">Restorative Yoga</span></p>   
                <i class="fa fa-clock-o" style="color:#3c5e61;"><!-- icon --></i> 30min
                <i class="fa fa-flag" style="color:#3c5e61;"><!-- icon --></i> Novice, Yogi
            </td>
            <td></td>
            <td></td>
            <td>
                <p><span style="color: #A58E65;">Vinyasa Yoga</span></p>   
